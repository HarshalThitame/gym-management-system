...
export default function OwnerErrorBoundary({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.bg, alignItems: "center", justifyContent: "center", padding: theme.spacing["2xl"] }}>
      ...
      <Text variant="h3" center style={{ marginTop: theme.spacing.xl, color: theme.colors.danger }}>Organization Error</Text>
