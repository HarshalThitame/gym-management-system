...
import { getChurnRiskAnalyticsV1, resolveGymScopeIds } from "@/features/attendance/lib/phase1-api";
...
export const GET = withApiAuth(async (request: NextRequest, context) => {
  ...
  const data = await getChurnRiskAnalyticsV1({ gymIds, gymId, branchId, limit });
