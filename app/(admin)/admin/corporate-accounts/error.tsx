...
export default function CorporateAccountsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => { console.error("Corporate accounts page error:", error); }, [error]);
  return (
    <div className="flex items-center justify-center py-24">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-5 text-xl font-black">Failed to load corporate accounts</h2>
