    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div><p className="font-semibold mb-3">Impact Warning</p><ImpactWarning title="This change affects multiple records" recordsAffected={2347} tenantsAffected={3} gymsAffected={14} isReversible={false} risks={[{ label: "This affects 2,347 active memberships", severity: "error" }, { label: "This action impacts 14 gyms", severity: "warning" }, { label: "This operation cannot be automatically reversed", severity: "error" }]} /></div>
          <div><p className="font-semibold mb-3">Audit Preview</p><AuditPreview title="Pending Changes" changes={[{ field: "Organization Status", before: "Active", after: "Suspended" }, { field: "Member Limit", before: "500", after: "0" }, { field: "Gym Access", before: "All Gyms", after: "Restricted" }]} /></div>
