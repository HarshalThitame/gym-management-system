      ...
      <Card className="w-full max-w-lg">
        <CardHeader>
          ...
          <p className="mt-5 text-xs font-black uppercase tracking-[0.14em] text-muted-foreground">
            {isTenantMismatch ? "Tenant access blocked" : isFeatureUnavailable ? "Feature unavailable" : "Access pending"}
          </p>
          <h1 className="mt-2 text-3xl font-black text-foreground">
            {isTenantMismatch ? "This account belongs to a different gym." : isFeatureUnavailable ? "This page is not available for your current plan." : "Your portal role is not active yet."}
          </h1>
