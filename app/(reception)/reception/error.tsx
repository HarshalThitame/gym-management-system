...
export default function ReceptionError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-24 text-center">
      ...
      <h1 className="text-2xl font-black">Failed to load reception panel</h1>
