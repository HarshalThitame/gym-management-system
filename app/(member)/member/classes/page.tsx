...
export default async function MemberClassesPage() {
  const context = await requireMemberPortalAccess("/member/classes");
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="Class Booking" title="Browse and book group sessions" description="Book upcoming classes, track waitlists, cancel within policy windows, and review attendance history." />
      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_0.85fr]">
        <AnimatedCardSection delay={0.1}>
          <Card variant="glass">
            <CardHeader><h3 className="text-2xl font-black">Available Classes</h3></CardHeader>
            ...
            <Card variant="glass">
              ...
              <CardContent className="space-y-3">
                {upcomingBookings.map((booking) => (
                  <div className="rounded-lg border border-border bg-surface-muted p-4 card-hover" key={booking.id}>
                    <div className="flex flex-wrap items-center gap-2">
            ...
            <Card variant="glass">
              ...
              <CardContent className="space-y-3">
                {portal.waitlists.slice(0, 8).map((waitlist) => (
                  <div className="rounded-lg border border-border bg-surface-muted p-3 card-hover" key={waitlist.id}>
                    <div className="flex flex-wrap items-center gap-2">
        ...
        <Card variant="glass">
          ...
          <CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {portal.attendance.slice(0, 12).map((row) => (
              <div className="rounded-lg border border-border bg-surface-muted p-3 card-hover" key={row.id}>
                <div className="flex flex-wrap items-center gap-2">
