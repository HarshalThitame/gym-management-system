...
export async function validateFeatureKeyIntegrity(): Promise<IntegrityResult> {
  ...
  const knownFlagToCode: Record<string, string> = {
    ...
    rfidAttendanceEnabled: "rfid_attendance",
    ...
    branchRevenueComparison: "branch_revenue_comparison", scheduledReportDelivery: "scheduled_report_delivery",
    ...
    multiBranchManagement: "multi_branch_management",
