...
export const FEATURE_KEYS = [
  ...
  "multi_currency_billing",
  "franchise_fee_management",
  "multi_gstin_support",
  "pos_merchandise_supplements",
  ...
  "hr_document_storage",
  "sso_saml_login",
  "dedicated_cloud_infrastructure",
  "dedicated_onboarding_manager",
  "response_sla",
  "named_account_manager",
  "automated_backups_90_day_retention",
  "uptime_sla_99_9",
