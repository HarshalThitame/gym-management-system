...
const FEATURE_MAP: Record<string, { type: "feature"; code: string } | { type: "limit"; code: string }> = {
  ...
  multiCurrencyBilling: { type: "feature", code: "multi_currency_billing" },
  franchiseFeeManagement: { type: "feature", code: "franchise_fee_management" },
  multiGstinSupport: { type: "feature", code: "multi_gstin_support" },
  posMerchandiseSupplements: { type: "feature", code: "pos_merchandise_supplements" },
  ...
  franchiseRollupDashboard: { type: "feature", code: "franchise_rollup_dashboard" },
  ...
  ssoSamlLogin: { type: "feature", code: "sso_saml_login" },
  dedicatedCloudInfrastructure: { type: "feature", code: "dedicated_cloud_infrastructure" },
  dedicatedOnboardingManager: { type: "feature", code: "dedicated_onboarding_manager" },
  responseSla: { type: "feature", code: "response_sla" },
  namedAccountManager: { type: "feature", code: "named_account_manager" },
  automatedBackups90DayRetention: { type: "feature", code: "automated_backups_90_day_retention" },
  uptimeSla99_9: { type: "feature", code: "uptime_sla_99_9" },
  staffTrainingSessions: { type: "feature", code: "staff_training_sessions" },
  customFeatureRequests: { type: "feature", code: "custom_feature_requests" },
};
